...
public partial class Ispr2335BarskovIaAsadContext : DbContext
{
    private static Ispr2335BarskovIaAsadContext instance;
    public static Ispr2335BarskovIaAsadContext init()
    {
        if (instance == null) instance = new Ispr2335BarskovIaAsadContext();
        return instance;
    }
    public Ispr2335BarskovIaAsadContext()
    {
    }

    public Ispr2335BarskovIaAsadContext(DbContextOptions<Ispr2335BarskovIaAsadContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=cfif31.ru;port=3306;userid=ISPr23-35_BarskovIA;password=ISPr23-35_BarskovIA;database=ISPr23-35_BarskovIA_asad;characterset=utf8", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.36-mysql"));
